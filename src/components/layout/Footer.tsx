 ...
 * Footer Component
 *
 * Main site footer with links and contact info
 */
...
const footerNavigation = {
  ...
  company: [
    ...
    { name: 'Coverage Areas', href: '/areas-we-cover' },
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              ...
              areas. Expert cleaning with eco-friendly products.
            </p>
