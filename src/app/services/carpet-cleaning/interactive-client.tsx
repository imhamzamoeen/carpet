...
import {
  Search, ArrowRight, Sparkles, Droplets, Wind, Zap, Heart, PawPrint,
  Leaf, Target, TrendingUp, BadgeCheck, ShieldCheck, Home
} from "lucide-react"
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative flex-1">
            ...
            <Input
              type="text"
              placeholder="Search carpet cleaning services..."
              ...
              <Card className="group h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer border-2 border-gray-100 hover:border-blue-300">
                <CardHeader>
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-sky-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
