  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-1 bg-gray-200 z-50">
        <div
          className="h-full bg-gradient-to-r from-slate-600 to-slate-700 transition-all duration-300"
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-40">
        ...
        {showScrollTop && (
          <Button
            onClick={scrollToTop}
            className="rounded-full shadow-lg bg-white text-slate-600 hover:bg-gray-50 w-12 h-12 p-0 border-2 border-slate-600"
            title="Scroll to top"
          >
