  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-40">
        <Link href="/quote">
          <Button className="rounded-full shadow-lg bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-semibold px-6 whitespace-nowrap transform hover:scale-105 transition-all duration-300">
        ...
        {showScrollTop && (
          <Button
            onClick={scrollToTop}
            className="rounded-full shadow-lg bg-white text-blue-600 hover:bg-gray-50 w-12 h-12 p-0"
            title="Scroll to top"
          >
