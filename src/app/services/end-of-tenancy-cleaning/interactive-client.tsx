...
import { Search, X, Filter, Sparkles, ArrowRight, Home, ChefHat, Droplet, Wind, Flame, Eye, Layers, Shield, CheckCircle2, Award, Zap, AlertTriangle, Lightbulb } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search end of tenancy services... (e.g., 'kitchen', 'oven', 'carpet')"
          value={searchQuery}
          ...
          aria-label="Search end of tenancy cleaning services"
        />
        {searchQuery && (
          <button
      ...
      <div className="text-center py-2">
        <p className="text-gray-600">
          ...
          <span className="font-bold">{subtopics.length}</span> end of tenancy services
        </p>
      </div>
      ...
      {filteredSubtopics.length > 0 ? (
        ...
        <div className="text-center py-12 bg-gray-50 rounded-2xl">
          ...
          <p className="text-gray-600 mb-6">
            No end of tenancy services match your search criteria. Try different keywords or clear filters.
          </p>
      ...
      {searchQuery === '' && selectedCategory === 'All' && (
        <div className="mt-12 p-6 bg-blue-50 rounded-2xl border-2 border-blue-200">
          <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
            ...
            Popular End of Tenancy Searches
          </h3>
