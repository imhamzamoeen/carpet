...
export const testimonials: Testimonial[] = [
  {
    ...
    location: 'Trafford',
    rating: 5,
    text: 'Blowup Cleaners did an amazing job on our living room carpet. The wine stain we thought was permanent is completely gone! Professional, friendly, and punctual.',
    date: '2025-01-10',
  ...
  },
  {
    ...
    location: 'Stockport',
    rating: 5,
    text: 'Our Persian rug is a family heirloom and I was nervous about getting it cleaned. Blowup Cleaners handled it with such care and it looks absolutely beautiful now.',
    date: '2024-12-28',
  ...
  },
  {
    ...
    location: 'Oldham',
    rating: 5,
    text: 'Been using Blowup Cleaners for 3 years now for our rental properties. Always reliable, thorough, and great value. Wouldn\'t use anyone else.',
    date: '2024-12-15',
